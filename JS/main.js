...
sites=[
    {
        'site_name':'발로봇 공식 사이트',
        'site_url':'https://valobot.netlify.app'
    },
...
function onSuccess(timeTotal) {
    ...
    ServerStatus.innerHTML="현재 핑 : " + timeTotal;
    isLive.innerHTML="현재 아무 문제없이 작동중입니다 "+"<span class='logged-in'>●</span>";
    innerHTML+="<br>";
    ...
    innerHTML+="<a target=_blank href="+url+"  class='btn btn-warning'>사이트 방문</a> &nbsp;";
    innerHTML+="<a target=_blank href=https://valobot.netlify.app/discord"+"  class=''>잘못된 정보 신고</a>";
...
function onFail() {
    isLive.innerHTML="사이트가 현재 응답하지 않습니다"+"<span class='logged-out'>●</span>";
    ServerStatus.innerHTML="왜인지는 모르겠지만 작동하지 않고 있군요! 빨리 고칠게요ㅠㅠ";
    innerHTML+="<br>";
    innerHTML+="<div class=card>";
    innerHTML+="<div class=card-header>"+site;
    innerHTML+="</div>";
